...
![The `LogFCLogFCPlot` panel class, alongside `RowDataPlot` and `RowDataTable` panels to which it transmits a feature set.](images/panels/iSEEu/LogFCLogFCPlot.png)
